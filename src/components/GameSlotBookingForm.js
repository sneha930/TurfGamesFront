...
const GameSlotBookingForm = () => {
  ...
  const handleSubmit = async(e) => {
    ...
    try {
      ...
      alert("Game slot booked successfully");
  ...
  return (
    ...
    <div className="max-w-md mx-auto mt-10 p-6 bg-white shadow-md rounded-2xl">
      <h2 className="text-2xl font-semibold mb-4 text-center text-gray-800">Book Your Game Slot</h2>
...
export default GameSlotBookingForm;
